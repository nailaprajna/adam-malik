...
<!DOCTYPE HTML>
<html>
<head><title>Hai adam</title>
<!-- Created By L3M4R1 -->
<script>alert ('hai')
alert ('i love u so much ')</script>
...
tb5_messages[0] = "Hay Adam malik";
tb5_messages[1] = "ini dari naila";
tb5_messages[2] = "Aku Sayang Sama Kamu";
tb5_messages[3] = "gemes banget";
tb5_messages[4] = "beruangg";
tb5_messages[5] = "mwaaaaaa <3";
tb5_messages[6] = "I Love You adaaammm!!!";
...
;(function(){
var msg = " kece gak sii bisa bikin gini😎";
var size = 15;
